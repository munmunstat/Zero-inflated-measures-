...
#G
#Gini MAtrix 
Gini_matrix_tru_developed<-GiniMatrix(mu, sigma, pi, R, Gini_corr_new)


# Print the result
print(Gini_matrix_tru_developed)

save(Gini_matrix_tru_developed,file = "Gini_matrix_tru_developed.RData")
