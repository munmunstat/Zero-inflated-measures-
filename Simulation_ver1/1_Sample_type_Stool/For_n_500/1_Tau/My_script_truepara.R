...
print(truetau_matrix_result)
save(truetau_matrix_result, file = "truetau_matrix_result.RData")


truetau_star<-calculate_tau_star(X=ziln_data[, 1],Y=ziln_data[, 2])
print(truetau_star)
save(truetau_star, file = "truetau_star.RData")

truetaustar_matrix_result<-kendallTaustar(ziln_data)
print(truetaustar_matrix_result)
save(truetaustar_matrix_result, file = "truetaustar_matrix_result.RData")
