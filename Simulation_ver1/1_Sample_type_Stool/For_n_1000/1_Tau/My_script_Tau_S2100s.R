###################################################################
# SLURM JOB SCRIPT: Kendall Tau Correlation for Stool sample n=1000
###################################################################
...
load("truetau_matrix_result.RData")
...
lower_tri_trutau <- truetau_matrix_result[lower.tri(truetau_matrix_result)]
...
save.image(file = paste0("TS2_simulation_task_", task_id, ".RData"))
