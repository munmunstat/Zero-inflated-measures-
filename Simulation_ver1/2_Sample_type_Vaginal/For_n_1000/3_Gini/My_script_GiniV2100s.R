##########################################################
# SLURM JOB SCRIPT: Gini Correlation Vaginal Sample n=1000
##########################################################
...
sim_data_file <- paste0("V2_sim_data_", task_id, ".RData")
...
fit_data_file <- paste0("fit_V2_data_", task_id, ".RData")
...
load("V_Gini_matrix_true_developed.RData")
...
lower_tri_truGini <- V_Gini_matrix_true_developed[lower.tri(V_Gini_matrix_true_developed)]
...
# Save all results
save.image(file = paste0("V2_Gini_simulation_task_", task_id, ".RData"))
