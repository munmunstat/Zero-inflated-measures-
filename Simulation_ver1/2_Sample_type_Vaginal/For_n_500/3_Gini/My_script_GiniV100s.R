##########################################################
# SLURM JOB SCRIPT: Gini Correlation Vaginal Sample n=500
##########################################################
...
fit_data_file <- paste0("fit_V_data_", task_id, ".RData")
...
# Save all results
save.image(file = paste0("V_Gini_simulation_task_", task_id, ".RData"))
