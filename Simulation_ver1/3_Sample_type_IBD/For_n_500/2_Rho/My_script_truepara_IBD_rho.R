...
IBD_truspearman_matrix_result <- spearmanMatrix(mu, sigma, pi, R, spearman_rho)
print(IBD_truspearman_matrix_result)
save(IBD_truspearman_matrix_result, file = "IBD_truspearman_matrix_result.RData")
