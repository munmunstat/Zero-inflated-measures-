...
IBD_Gini_matrix_true_developed<-GiniMatrix(mu, sigma, pi, R, Gini_corr_new_Aspace)


save(IBD_Gini_matrix_true_developed,file = "IBD_Gini_matrix_true_developed.RData")
