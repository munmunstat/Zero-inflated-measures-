...
V_truspearman_matrix_result <- spearmanMatrix(mu, sigma, pi, R, spearman_rho)
print(V_truspearman_matrix_result)
save(V_truspearman_matrix_result, file = "V_truspearman_matrix_result.RData")



# Use the new spearmanMatrix function using package
V_truspearman_rho_matrix_result_package <- spearmanMatrix_package(ziln_data)
print(V_truspearman_rho_matrix_result_package)
save(V_truspearman_rho_matrix_result_package , file = "V_truspearman_rho_matrix_result_package.RData")


# Compute rho_star matrix
V_truerho_star_result <- rho_star_matrix(ziln_data)
print(V_truerho_star_result)
save(V_truerho_star_result, file = "V_truerho_star_result.RData")
