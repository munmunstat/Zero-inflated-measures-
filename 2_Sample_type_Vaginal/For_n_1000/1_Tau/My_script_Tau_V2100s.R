############################################
# SLURM JOB SCRIPT: Kendall Tau Correlation for Vaginal sample n=1000
############################################
...
load("V_truetau_matrix_result.RData")
...
lower_tri_trutau <- V_truetau_matrix_result[lower.tri(V_truetau_matrix_result)]
...
save.image(file = paste0("TV2_simulation_task_", task_id, ".RData"))
