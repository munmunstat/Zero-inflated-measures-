############################################
# SLURM JOB SCRIPT: Gini Correlation Kendell tau Stool sample n=1000
############################################
...
sim_data_file <- paste0("sim_data6_", task_id, ".RData")
...
fit_data_file <- paste0("fit_data_S2_", task_id, ".RData")
...
load("Gini_matrix_tru_developed.RData")
...
lower_tri_truGini <- Gini_matrix_tru_developed[lower.tri(Gini_matrix_tru_developed)]
...
# Save all results
save.image(file = paste0("GiniS2_simulation_task_", task_id, ".RData"))
